...
public class FPSRegisterTest {
    ...
    @Test
    public void test01_RegistFeaturePatternSetting() {
        ...
        TPSRoot tpsRoot = (TPSRoot) root;
        TCNode tcNode = tpsRoot.getRootNodes().get(0);
        TCProperty tcProp = TCFactory.eINSTANCE.createTCProperty();
        tcProp.setKey("risk");
        tcProp.setValue("10");
        tcNode.getProperties().add(tcProp);
        TCProperty tcProp2 = TCFactory.eINSTANCE.createTCProperty();
        tcProp2.setKey("");
        tcProp2.setValue("");
        tcNode.getProperties().add(tcProp2);
