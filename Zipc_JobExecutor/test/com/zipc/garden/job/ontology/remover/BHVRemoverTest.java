...
public class BHVRemoverTest {
    ...
    private static Path contentsFolderPath = Paths.get("test/resources/com/zipc/garden/job/ontology/register/content/bp");

    /**
     * Add user, project, content(arc, fsm, bps)
     */
    @BeforeClass
    ...
    @Test
    public void test01_RegistBehaviorModelCar1() {
        VMFile vmFile = getVMFile("Car1.fsm");
    ...
    @Test
    public void test02_RemoveBehaviorModelCar1() {
        VMFile vmFile = getVMFile("Car1.fsm");
        long fileId = vmFile.getId();
        File file = EditResourceUtil.INSTANCE.getFile(fileId);
    ...
    @Test
    public void test03_RegistBehaviorModelCar3() {
        VMFile vmFile = getVMFile("Car3.fsm");
        long fileId = vmFile.getId();
        File file = EditResourceUtil.INSTANCE.getFile(fileId);
        byte[] data = EditResourceUtil.INSTANCE.getFileContent(fileId);
        AbstractRootElement root = EditResourceUtil.INSTANCE.convertToRootElement(data);
    ...
    @Test
    public void test04_RemoveBehaviorModelCar3() {
        VMFile vmFile = getVMFile("Car3.fsm");
        long fileId = vmFile.getId();
        File file = EditResourceUtil.INSTANCE.getFile(fileId);
        IRDFRemover remover = OntologyUtils.createRemover(file);
