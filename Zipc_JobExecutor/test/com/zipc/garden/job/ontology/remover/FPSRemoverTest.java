...
public class FPSRemoverTest {
    ...
    @Test
    public void test01_RemoveFeaturePatternSettings() {
        VMFile vmFile = getVMFile("TSD.fps");
        long fileId = vmFile.getId();
        File file = EditResourceUtil.INSTANCE.getFile(fileId);
        EditResourceUtil.INSTANCE.removeResources(Arrays.asList((VMResource) vmFile), null);
