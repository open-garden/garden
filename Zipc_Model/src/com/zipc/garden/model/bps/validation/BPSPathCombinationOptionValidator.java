...
/**
 * A sample validator interface for {@link com.zipc.garden.model.bps.BPSPathCombinationOption}. This doesn't really do anything,
 ...
 */
public interface BPSPathCombinationOptionValidator {
    boolean validate();

    boolean validatePathLength(int value);
}
