...
/**
 * A sample validator interface for {@link com.zipc.garden.model.cb.CBRoot}. This doesn't really do anything, and it's not a
 ...
 */
public interface CBRootValidator {
    boolean validate();

    boolean validateLogic(CBLogic value);

    boolean validateLayoutMode(int value);
}
