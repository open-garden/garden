/**
 */
package com.zipc.garden.model.cgen.util;
 ...
 * @generated
 */
public class CGENAdapterFactory extends AdapterFactoryImpl {
    /**
     * The cached model package. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected static CGENPackage modelPackage;

    /**
     * Creates an instance of the adapter factory. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    public CGENAdapterFactory() {
        if (modelPackage == null) {
            modelPackage = CGENPackage.eINSTANCE;
        }
    }
     ...
     * @generated
     */
    protected CGENSwitch<Adapter> modelSwitch = new CGENSwitch<Adapter>() {
        @Override
        public Adapter caseCGENRoot(CGENRoot object) {
            return createCGENRootAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.cgen.CGENRoot <em>Root</em>}'. <!--
     ...
     * @generated
     */
    public Adapter createCGENRootAdapter() {
        return null;
    }
