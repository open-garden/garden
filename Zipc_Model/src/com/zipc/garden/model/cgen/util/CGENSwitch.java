 ...
 * @generated
 */
public class CGENSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case CGENPackage.CGEN_ROOT: {
            CGENRoot cgenRoot = (CGENRoot) theEObject;
            T result = caseCGENRoot(cgenRoot);
            if (result == null)
                result = caseAbstractRootElement(cgenRoot);
            if (result == null)
     ...
     * @generated
     */
    public T caseCGENRoot(CGENRoot object) {
        return null;
    }
