...
import com.zipc.garden.model.csc.CSCFactory;
import com.zipc.garden.model.csc.CSCPackage;
import com.zipc.garden.model.csc.CSCRoot;
 ...
 * @generated
 */
public class CSCPackageImpl extends EPackageImpl implements CSCPackage {
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    private EClass cscRootEClass = null;
     ...
     * @see com.zipc.garden.model.csc.CSCPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private CSCPackageImpl() {
        super(eNS_URI, CSCFactory.eINSTANCE);
    }
     ...
     * <p>
     * This method is used to initialize {@link CSCPackage#eINSTANCE} when that field is accessed. Clients should not invoke it
     ...
     * @generated
     */
    public static CSCPackage init() {
        if (isInited)
            return (CSCPackage) EPackage.Registry.INSTANCE.getEPackage(CSCPackage.eNS_URI);

        initializeRegistryHelpers();

        // Obtain or create and register package
        Object registeredCSCPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        CSCPackageImpl theCSCPackage = registeredCSCPackage instanceof CSCPackageImpl ? (CSCPackageImpl) registeredCSCPackage : new CSCPackageImpl();
        ...
        theCSCPackage.freeze();

        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(CSCPackage.eNS_URI, theCSCPackage);
        return theCSCPackage;
    }
    ...
    public static void initializeRegistryHelpers() {
        Reflect.register(CSCRoot.class, new Reflect.Helper() {
            public boolean isInstance(Object instance) {
                return instance instanceof CSCRoot;
            }

            public Object newArrayInstance(int size) {
                return new CSCRoot[size];
            }
        });
    }
     ...
     */
    @Override
    public EClass getCSCRoot() {
        return cscRootEClass;
    }
     ...
     */
    @Override
    public CSCFactory getCSCFactory() {
        return (CSCFactory) getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        cscRootEClass = createEClass(CSC_ROOT);
    }
    ...
    public void initializePackageContents() {
        ...
        cscRootEClass.getESuperTypes().add(theCOREPackage.getAbstractRootElement());

        // Initialize classes, features, and operations; add parameters
        initEClass(cscRootEClass, CSCRoot.class, "CSCRoot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
