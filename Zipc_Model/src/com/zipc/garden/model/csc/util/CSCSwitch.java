 ...
 * @generated
 */
public class CSCSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case CSCPackage.CSC_ROOT: {
            CSCRoot cscRoot = (CSCRoot) theEObject;
            T result = caseCSCRoot(cscRoot);
            if (result == null)
                result = caseAbstractRootElement(cscRoot);
            if (result == null)
     ...
     * @generated
     */
    public T caseCSCRoot(CSCRoot object) {
        return null;
    }
