 ...
 * @generated
 */
public class CSCSPackageImpl extends EPackageImpl implements CSCSPackage {
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    private EClass cscsRootEClass = null;

    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    private EClass cscsPatternEClass = null;
     ...
     * @see com.zipc.garden.model.cscs.CSCSPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private CSCSPackageImpl() {
        super(eNS_URI, CSCSFactory.eINSTANCE);
    }
     ...
     * <p>
     * This method is used to initialize {@link CSCSPackage#eINSTANCE} when that field is accessed. Clients should not invoke it
     ...
     * @generated
     */
    public static CSCSPackage init() {
        if (isInited)
            return (CSCSPackage) EPackage.Registry.INSTANCE.getEPackage(CSCSPackage.eNS_URI);

        initializeRegistryHelpers();

        // Obtain or create and register package
        Object registeredCSCSPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        CSCSPackageImpl theCSCSPackage = registeredCSCSPackage instanceof CSCSPackageImpl ? (CSCSPackageImpl) registeredCSCSPackage : new CSCSPackageImpl();
        ...
        theCSCSPackage.freeze();

        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(CSCSPackage.eNS_URI, theCSCSPackage);
        return theCSCSPackage;
    }
    ...
    public static void initializeRegistryHelpers() {
        Reflect.register(CSCSRoot.class, new Reflect.Helper() {
            public boolean isInstance(Object instance) {
                return instance instanceof CSCSRoot;
            }

            public Object newArrayInstance(int size) {
                return new CSCSRoot[size];
            }
        });
        Reflect.register(CSCSPattern.class, new Reflect.Helper() {
            public boolean isInstance(Object instance) {
                return instance instanceof CSCSPattern;
            }

            public Object newArrayInstance(int size) {
                return new CSCSPattern[size];
            }
        });
    }
    ...
    public static class WhiteList implements IsSerializable, EBasicWhiteList {
         ...
         * @generated
         */
        protected CSCSRoot cscsRoot;

        /**
         * <!-- begin-user-doc --> <!-- end-user-doc -->
         * @generated
         */
        protected CSCSPattern cscsPattern;
     ...
     */
    @Override
    public EClass getCSCSRoot() {
        return cscsRootEClass;
    }
     ...
     */
    @Override
    public EAttribute getCSCSRoot_All() {
        return (EAttribute) cscsRootEClass.getEStructuralFeatures().get(0);
    }
     ...
     */
    @Override
    public EAttribute getCSCSRoot_Begin() {
        return (EAttribute) cscsRootEClass.getEStructuralFeatures().get(1);
    }
     ...
     */
    @Override
    public EAttribute getCSCSRoot_End() {
        return (EAttribute) cscsRootEClass.getEStructuralFeatures().get(2);
    }
     ...
     */
    @Override
    public EAttribute getCSCSRoot_Status() {
        return (EAttribute) cscsRootEClass.getEStructuralFeatures().get(3);
    }
     ...
     */
    @Override
    public EAttribute getCSCSRoot_Message() {
        return (EAttribute) cscsRootEClass.getEStructuralFeatures().get(4);
    }
     ...
     */
    @Override
    public EReference getCSCSRoot_Patterns() {
        return (EReference) cscsRootEClass.getEStructuralFeatures().get(5);
    }
     ...
     */
    @Override
    public EClass getCSCSPattern() {
        return cscsPatternEClass;
    }
     ...
     */
    @Override
    public EAttribute getCSCSPattern_Id() {
        return (EAttribute) cscsPatternEClass.getEStructuralFeatures().get(0);
    }
     ...
     */
    @Override
    public EAttribute getCSCSPattern_PatternValue() {
        return (EAttribute) cscsPatternEClass.getEStructuralFeatures().get(1);
    }
     ...
     */
    @Override
    public EAttribute getCSCSPattern_Csc() {
        return (EAttribute) cscsPatternEClass.getEStructuralFeatures().get(2);
    }
     ...
     */
    @Override
    public CSCSFactory getCSCSFactory() {
        return (CSCSFactory) getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        cscsRootEClass = createEClass(CSCS_ROOT);
        createEAttribute(cscsRootEClass, CSCS_ROOT__ALL);
        createEAttribute(cscsRootEClass, CSCS_ROOT__BEGIN);
        createEAttribute(cscsRootEClass, CSCS_ROOT__END);
        createEAttribute(cscsRootEClass, CSCS_ROOT__STATUS);
        createEAttribute(cscsRootEClass, CSCS_ROOT__MESSAGE);
        createEReference(cscsRootEClass, CSCS_ROOT__PATTERNS);

        cscsPatternEClass = createEClass(CSCS_PATTERN);
        createEAttribute(cscsPatternEClass, CSCS_PATTERN__ID);
        createEAttribute(cscsPatternEClass, CSCS_PATTERN__PATTERN_VALUE);
        createEAttribute(cscsPatternEClass, CSCS_PATTERN__CSC);
    }
    ...
    public void initializePackageContents() {
        ...
        cscsRootEClass.getESuperTypes().add(theCOREPackage.getAbstractRootElement());

        // Initialize classes, features, and operations; add parameters
        initEClass(cscsRootEClass, CSCSRoot.class, "CSCSRoot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCSCSRoot_All(), ecorePackage.getEDouble(), "all", null, 0, 1, CSCSRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCSCSRoot_Begin(), theXMLTypePackage.getInt(), "begin", null, 0, 1, CSCSRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCSCSRoot_End(), theXMLTypePackage.getInt(), "end", null, 0, 1, CSCSRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCSCSRoot_Status(), theXMLTypePackage.getInt(), "status", "-1", 0, 1, CSCSRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCSCSRoot_Message(), theXMLTypePackage.getString(), "message", null, 0, 1, CSCSRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getCSCSRoot_Patterns(), this.getCSCSPattern(), null, "patterns", null, 0, -1, CSCSRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(cscsPatternEClass, CSCSPattern.class, "CSCSPattern", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCSCSPattern_Id(), ecorePackage.getEString(), "id", null, 0, 1, CSCSPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCSCSPattern_PatternValue(), ecorePackage.getEString(), "patternValue", null, 0, 1, CSCSPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCSCSPattern_Csc(), ecorePackage.getEString(), "csc", null, 0, 1, CSCSPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
