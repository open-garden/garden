/**
 */
package com.zipc.garden.model.cscs.util;
 ...
 * @generated
 */
public class CSCSAdapterFactory extends AdapterFactoryImpl {
    /**
     * The cached model package. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected static CSCSPackage modelPackage;

    /**
     * Creates an instance of the adapter factory. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    public CSCSAdapterFactory() {
        if (modelPackage == null) {
            modelPackage = CSCSPackage.eINSTANCE;
        }
    }
     ...
     * @generated
     */
    protected CSCSSwitch<Adapter> modelSwitch = new CSCSSwitch<Adapter>() {
        @Override
        public Adapter caseCSCSRoot(CSCSRoot object) {
            return createCSCSRootAdapter();
        }

        @Override
        public Adapter caseCSCSPattern(CSCSPattern object) {
            return createCSCSPatternAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.cscs.CSCSRoot <em>Root</em>}'. <!--
     ...
     * @generated
     */
    public Adapter createCSCSRootAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.cscs.CSCSPattern <em>Pattern</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
     * case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createCSCSPatternAdapter() {
        return null;
    }
