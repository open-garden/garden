 ...
 * @generated
 */
public class CSCSSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case CSCSPackage.CSCS_ROOT: {
            CSCSRoot cscsRoot = (CSCSRoot) theEObject;
            T result = caseCSCSRoot(cscsRoot);
            if (result == null)
                result = caseAbstractRootElement(cscsRoot);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case CSCSPackage.CSCS_PATTERN: {
            CSCSPattern cscsPattern = (CSCSPattern) theEObject;
            T result = caseCSCSPattern(cscsPattern);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
     ...
     * @generated
     */
    public T caseCSCSRoot(CSCSRoot object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseCSCSPattern(CSCSPattern object) {
        return null;
    }
