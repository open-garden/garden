...
/**
 * A sample validator interface for {@link com.zipc.garden.model.cscs.CSCSRoot}. This doesn't really do anything, and it's not a
 ...
 */
public interface CSCSRootValidator {
    boolean validate();
    ...
    boolean validatePatterns(EList<CSCSPattern> value);
}
