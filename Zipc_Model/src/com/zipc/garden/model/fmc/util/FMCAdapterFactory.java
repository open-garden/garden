...
public class FMCAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected FMCSwitch<Adapter> modelSwitch = new FMCSwitch<Adapter>() {
        @Override
        public Adapter caseFMCRoot(FMCRoot object) {
            return createFMCRootAdapter();
        }

        @Override
        public Adapter caseFMCConstraint(FMCConstraint object) {
            return createFMCConstraintAdapter();
        }

        @Override
        public Adapter caseFMCNodePath(FMCNodePath object) {
            return createFMCNodePathAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.fmc.FMCRoot <em>Root</em>}'. <!--
     ...
     * @generated
     */
    public Adapter createFMCRootAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.fmc.FMCConstraint <em>Constraint</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
     * case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createFMCConstraintAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.fmc.FMCNodePath <em>Node Path</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
     * case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createFMCNodePathAdapter() {
        return null;
    }
