...
/**
 * A sample validator interface for {@link com.zipc.garden.model.fmcs.FMCSImpliesExpression}. This doesn't really do anything,
 ...
 */
public interface FMCSImpliesExpressionValidator {
    boolean validate();

    boolean validateLeftExpression(FMCSExpression value);

    boolean validateRightExpression(FMCSExpression value);
}
