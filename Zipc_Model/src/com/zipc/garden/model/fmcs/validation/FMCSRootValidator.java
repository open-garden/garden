...
/**
 * A sample validator interface for {@link com.zipc.garden.model.fmcs.FMCSRoot}. This doesn't really do anything, and it's not a
 ...
 */
public interface FMCSRootValidator {
    boolean validate();

    boolean validateConstraints(EList<FMCSConstraint> value);
}
