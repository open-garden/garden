...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>DPseudo State Type</b></em>', and utility
 * methods for working with them. <!-- end-user-doc -->
 * @see com.zipc.garden.model.fsm.FSMPackage#getFSMDPseudoStateType()
 * @model
 * @generated
 */
public enum FSMDPseudoStateType implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>DPseudo State Type</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    private static final FSMDPseudoStateType[] VALUES_ARRAY = new FSMDPseudoStateType[] { JOIN, FORK, JUNCTION, CHOICE, ENTRY_POINT, EXIT_POINT, TERMINATE, INITIAL, FINAL,
            DEEP_HISTORY, SHALLOW_HISTORY, NONE, };

    /**
     * A public read-only list of all the '<em><b>DPseudo State Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @generated
     */
    public static final List<FSMDPseudoStateType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>DPseudo State Type</b></em>' literal with the specified literal value. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @param literal the literal.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static FSMDPseudoStateType get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            FSMDPseudoStateType result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>DPseudo State Type</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static FSMDPseudoStateType getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            FSMDPseudoStateType result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>DPseudo State Type</b></em>' literal with the specified integer value. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @param value the integer value.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static FSMDPseudoStateType get(int value) {
        switch (value) {
        case JOIN_VALUE:
            return JOIN;
        case FORK_VALUE:
     ...
     * @generated
     */
    private FSMDPseudoStateType(int value, String name, String literal) {
        this.value = value;
        this.name = name;
