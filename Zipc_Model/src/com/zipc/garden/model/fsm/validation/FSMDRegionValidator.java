...
/**
 * A sample validator interface for {@link com.zipc.garden.model.fsm.FSMDRegion}. This doesn't really do anything, and it's not
 ...
 */
public interface FSMDRegionValidator {
    boolean validate();

    boolean validateStates(EList<FSMDState> value);
}
