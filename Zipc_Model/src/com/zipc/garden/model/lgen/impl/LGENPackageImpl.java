...
import com.zipc.garden.model.lgen.LGENFactory;
import com.zipc.garden.model.lgen.LGENPackage;
import com.zipc.garden.model.lgen.LGENRoot;
 ...
 * @generated
 */
public class LGENPackageImpl extends EPackageImpl implements LGENPackage {
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    private EClass lgenRootEClass = null;
     ...
     * @see com.zipc.garden.model.lgen.LGENPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private LGENPackageImpl() {
        super(eNS_URI, LGENFactory.eINSTANCE);
    }
     ...
     * <p>
     * This method is used to initialize {@link LGENPackage#eINSTANCE} when that field is accessed. Clients should not invoke it
     ...
     * @generated
     */
    public static LGENPackage init() {
        if (isInited)
            return (LGENPackage) EPackage.Registry.INSTANCE.getEPackage(LGENPackage.eNS_URI);

        initializeRegistryHelpers();

        // Obtain or create and register package
        Object registeredLGENPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        LGENPackageImpl theLGENPackage = registeredLGENPackage instanceof LGENPackageImpl ? (LGENPackageImpl) registeredLGENPackage : new LGENPackageImpl();
        ...
        theLGENPackage.freeze();

        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(LGENPackage.eNS_URI, theLGENPackage);
        return theLGENPackage;
    }
    ...
    public static void initializeRegistryHelpers() {
        Reflect.register(LGENRoot.class, new Reflect.Helper() {
            public boolean isInstance(Object instance) {
                return instance instanceof LGENRoot;
            }

            public Object newArrayInstance(int size) {
                return new LGENRoot[size];
            }
        });
    }
     ...
     */
    @Override
    public EClass getLGENRoot() {
        return lgenRootEClass;
    }
     ...
     */
    @Override
    public LGENFactory getLGENFactory() {
        return (LGENFactory) getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        lgenRootEClass = createEClass(LGEN_ROOT);
    }
    ...
    public void initializePackageContents() {
        ...
        lgenRootEClass.getESuperTypes().add(theCOREPackage.getAbstractRootElement());

        // Initialize classes, features, and operations; add parameters
        initEClass(lgenRootEClass, LGENRoot.class, "LGENRoot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
