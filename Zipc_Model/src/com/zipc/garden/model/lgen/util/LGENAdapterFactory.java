/**
 */
package com.zipc.garden.model.lgen.util;
 ...
 * @generated
 */
public class LGENAdapterFactory extends AdapterFactoryImpl {
    /**
     * The cached model package. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected static LGENPackage modelPackage;

    /**
     * Creates an instance of the adapter factory. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    public LGENAdapterFactory() {
        if (modelPackage == null) {
            modelPackage = LGENPackage.eINSTANCE;
        }
    }
     ...
     * @generated
     */
    protected LGENSwitch<Adapter> modelSwitch = new LGENSwitch<Adapter>() {
        @Override
        public Adapter caseLGENRoot(LGENRoot object) {
            return createLGENRootAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.lgen.LGENRoot <em>Root</em>}'. <!--
     ...
     * @generated
     */
    public Adapter createLGENRootAdapter() {
        return null;
    }
