 ...
 * @generated
 */
public class LGENSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case LGENPackage.LGEN_ROOT: {
            LGENRoot lgenRoot = (LGENRoot) theEObject;
            T result = caseLGENRoot(lgenRoot);
            if (result == null)
                result = caseAbstractRootElement(lgenRoot);
            if (result == null)
     ...
     * @generated
     */
    public T caseLGENRoot(LGENRoot object) {
        return null;
    }
