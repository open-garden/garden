/**
 */
package com.zipc.garden.model.lsc.util;
 ...
 * @generated
 */
public class LSCAdapterFactory extends AdapterFactoryImpl {
    /**
     * The cached model package. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected static LSCPackage modelPackage;

    /**
     * Creates an instance of the adapter factory. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    public LSCAdapterFactory() {
        if (modelPackage == null) {
            modelPackage = LSCPackage.eINSTANCE;
        }
    }
     ...
     * @generated
     */
    protected LSCSwitch<Adapter> modelSwitch = new LSCSwitch<Adapter>() {
        @Override
        public Adapter caseLSCRoot(LSCRoot object) {
            return createLSCRootAdapter();
        }

        @Override
        public Adapter caseLSCScenario(LSCScenario object) {
            return createLSCScenarioAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.lsc.LSCRoot <em>Root</em>}'. <!--
     ...
     * @generated
     */
    public Adapter createLSCRootAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.lsc.LSCScenario <em>Scenario</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
     * case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createLSCScenarioAdapter() {
        return null;
    }
