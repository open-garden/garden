 ...
 * @generated
 */
public class LSCSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case LSCPackage.LSC_ROOT: {
            LSCRoot lscRoot = (LSCRoot) theEObject;
            T result = caseLSCRoot(lscRoot);
            if (result == null)
                result = caseAbstractRootElement(lscRoot);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case LSCPackage.LSC_SCENARIO: {
            LSCScenario lscScenario = (LSCScenario) theEObject;
            T result = caseLSCScenario(lscScenario);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
     ...
     * @generated
     */
    public T caseLSCRoot(LSCRoot object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseLSCScenario(LSCScenario object) {
        return null;
    }
