 ...
 * @generated
 */
public class GPModelSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case GPModelPackage.GP_RESOURCE: {
            GPResource gpResource = (GPResource) theEObject;
            T result = caseGPResource(gpResource);
            if (result == null)
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>GP Resource</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>GP Resource</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseGPResource(GPResource object) {
        return null;
    }
