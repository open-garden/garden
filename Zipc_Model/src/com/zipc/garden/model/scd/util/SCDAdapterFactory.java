/**
 */
package com.zipc.garden.model.scd.util;
...
public class SCDAdapterFactory extends AdapterFactoryImpl {
    ...
    protected SCDSwitch<Adapter> modelSwitch = new SCDSwitch<Adapter>() {
        @Override
        public Adapter caseSCDRoot(SCDRoot object) {
            return createSCDRootAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.scd.SCDRoot <em>Root</em>}'. <!--
     ...
     * @generated
     */
    public Adapter createSCDRootAdapter() {
        return null;
    }
