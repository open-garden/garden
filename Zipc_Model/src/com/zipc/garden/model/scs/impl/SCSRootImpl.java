 ...
 * </p>
 * <ul>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getMax <em>Max</em>}</li>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getRowIds <em>Row Ids</em>}</li>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getSettings <em>Settings</em>}</li>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getAll <em>All</em>}</li>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getBegin <em>Begin</em>}</li>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getEnd <em>End</em>}</li>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getStatus <em>Status</em>}</li>
 * <li>{@link com.zipc.garden.model.scs.impl.SCSRootImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * @generated
 */
public class SCSRootImpl extends AbstractRootElementImpl implements SCSRoot {
    /**
    ...
    protected EClass eStaticClass() {
        return SCSPackage.Literals.SCS_ROOT;
    }
    ...
    public void setAll(double newAll) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCSPackage.SCS_ROOT__ALL, oldAll, all));
    }
    ...
    public void setBegin(int newBegin) {
        ...
        begin = newBegin;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCSPackage.SCS_ROOT__BEGIN, oldBegin, begin));
    }
    ...
    public void setEnd(int newEnd) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCSPackage.SCS_ROOT__END, oldEnd, end));
    }
    ...
    public void setStatus(int newStatus) {
        ...
        status = newStatus;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCSPackage.SCS_ROOT__STATUS, oldStatus, status));
    }
    ...
    public void setMessage(String newMessage) {
        ...
        message = newMessage;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCSPackage.SCS_ROOT__MESSAGE, oldMessage, message));
    }
    ...
    public void setMax(int newMax) {
        ...
        max = newMax;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCSPackage.SCS_ROOT__MAX, oldMax, max));
    }
    ...
    public void setRowIds(String newRowIds) {
        ...
        rowIds = newRowIds;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCSPackage.SCS_ROOT__ROW_IDS, oldRowIds, rowIds));
    }
    ...
    public EList<AbstractSetting> getSettings() {
        if (settings == null) {
            settings = new EObjectContainmentEList<AbstractSetting>(AbstractSetting.class, this, SCSPackage.SCS_ROOT__SETTINGS);
        }
        return settings;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SCSPackage.SCS_ROOT__SETTINGS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SCSPackage.SCS_ROOT__MAX:
            return getMax();
        case SCSPackage.SCS_ROOT__ROW_IDS:
            return getRowIds();
        case SCSPackage.SCS_ROOT__SETTINGS:
            return getSettings();
        case SCSPackage.SCS_ROOT__ALL:
            return getAll();
        case SCSPackage.SCS_ROOT__BEGIN:
            return getBegin();
        case SCSPackage.SCS_ROOT__END:
            return getEnd();
        case SCSPackage.SCS_ROOT__STATUS:
            return getStatus();
        case SCSPackage.SCS_ROOT__MESSAGE:
            return getMessage();
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == AbstractSearchCondition.class) {
            ...
            case COREPackage.ABSTRACT_SEARCH_CONDITION__MAX:
                return SCSPackage.SCS_ROOT__MAX;
            case COREPackage.ABSTRACT_SEARCH_CONDITION__ROW_IDS:
                return SCSPackage.SCS_ROOT__ROW_IDS;
            default:
                return -1;
            }
        }
        if (baseClass == SettingInterface.class) {
            ...
            case COREPackage.SETTING_INTERFACE__SETTINGS:
                return SCSPackage.SCS_ROOT__SETTINGS;
            default:
                return -1;
            }
        }
