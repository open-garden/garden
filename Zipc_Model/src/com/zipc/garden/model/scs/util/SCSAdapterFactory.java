 ...
 * @generated
 */
public class SCSAdapterFactory extends AdapterFactoryImpl {
    /**
     ...
     * @generated
     */
    protected SCSSwitch<Adapter> modelSwitch = new SCSSwitch<Adapter>() {
        @Override
        public Adapter caseSCSRoot(SCSRoot object) {
            return createSCSRootAdapter();
        }

        @Override
        public Adapter caseSCSPattern(SCSPattern object) {
            return createSCSPatternAdapter();
        }

        @Override
        public Adapter caseSCSPatternReference(SCSPatternReference object) {
            return createSCSPatternReferenceAdapter();
        }

        @Override
        public Adapter caseSCSSetting(SCSSetting object) {
            return createSCSSettingAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.scs.SCSRoot <em>Root</em>}'. <!--
     ...
     * @generated
     */
    public Adapter createSCSRootAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.scs.SCSPattern <em>Pattern</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
     * case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createSCSPatternAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.scs.SCSPatternReference <em>Pattern
     * Reference</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
     * @see com.zipc.garden.model.scs.SCSPatternReference
     * @generated
     */
    public Adapter createSCSPatternReferenceAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link com.zipc.garden.model.scs.SCSSetting <em>Setting</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
     * case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createSCSSettingAdapter() {
        return null;
    }
