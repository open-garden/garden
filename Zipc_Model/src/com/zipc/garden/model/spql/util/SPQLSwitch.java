 ...
 * @generated
 */
public class SPQLSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case SPQLPackage.SPQL_ROOT: {
            SPQLRoot spqlRoot = (SPQLRoot) theEObject;
            T result = caseSPQLRoot(spqlRoot);
            if (result == null)
                result = caseAbstractRootElement(spqlRoot);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SPQLPackage.SPQL_SETTING: {
            SPQLSetting spqlSetting = (SPQLSetting) theEObject;
            T result = caseSPQLSetting(spqlSetting);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
     ...
     * @generated
     */
    public T caseSPQLRoot(SPQLRoot object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseSPQLSetting(SPQLSetting object) {
        return null;
    }
