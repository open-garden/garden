...
public class TCSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case TCPackage.TC_ROOT: {
            TCRoot tcRoot = (TCRoot) theEObject;
            T result = caseTCRoot(tcRoot);
            if (result == null)
                result = caseAbstractRootElement(tcRoot);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TCPackage.TC_NODE: {
            TCNode tcNode = (TCNode) theEObject;
            T result = caseTCNode(tcNode);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
     ...
     * @generated
     */
    public T caseTCRoot(TCRoot object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseTCNode(TCNode object) {
        return null;
    }
