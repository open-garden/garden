 ...
 * @generated
 */
public class TPSSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case TPSPackage.TPS_ROOT: {
            TPSRoot tpsRoot = (TPSRoot) theEObject;
            T result = caseTPSRoot(tpsRoot);
            if (result == null)
                result = caseAbstractRootElement(tpsRoot);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TPSPackage.TPS_PATTERN_ELEMENT: {
            TPSPatternElement tpsPatternElement = (TPSPatternElement) theEObject;
            T result = caseTPSPatternElement(tpsPatternElement);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
     ...
     * @generated
     */
    public T caseTPSRoot(TPSRoot object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseTPSPatternElement(TPSPatternElement object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '<em>Node Variable</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * @param object the target of the switch.
