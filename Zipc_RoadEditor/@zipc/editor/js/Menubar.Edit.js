...
var MenubarEdit = function (editor) {
	...
	var cloneConnect = new UIRow();
	cloneConnect.setClass('option');
	cloneConnect.setTextContent(strings.getKey('menubar/edit/clone_connect'));
	cloneConnect.onClick(function () {
	...
	options.add(cloneConnect);


	editor.signals.objectSelected.add(function (object) {

		if (object !== null && object.type === 'Road') {

			cloneConnect.setClass('option');

		} else {

			cloneConnect.setClass('inactive');
