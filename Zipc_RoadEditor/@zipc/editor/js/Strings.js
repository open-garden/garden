...
var Strings = function (config) {
	...
	var values = {
		...
		en: {
			...
			//#####################################
			//Settings
			'menubar/setting/wireframe': 'Wireframe',
			'menubar/setting/reference_line': 'Reference line',
			'menubar/setting/controlSprite': 'Control Sprite',

			'sidebar/object/waypoint/id': 'WayPoint ID',
			'sidebar/object/waypoint/index': 'Index',

			// Scenario
			'sidebar/scenario': 'Road',
			'sidebar/scenario/direction': 'Direction',
			'sidebar/actor': 'Actor',
			'sidebar/route': 'Route',
			'sidebar/roadmark': 'RoadMark',
			'sidebar/envobject': 'EnvObject',
			'sidebar/trajectory': 'Trajectory',
			'sidebar/scenario/background/image': 'Image',
			'sidebar/scenario/background/00': ' Background 00 ',
			'sidebar/scenario/background/01': ' Background 01 ',
			'sidebar/scenario/background/02': ' Background 02 ',
			'sidebar/scenario/background/00/top': 'Top',
			'sidebar/scenario/background/00/bottom': 'Bottom',
			'sidebar/scenario/background/00/left': 'Left',
			'sidebar/scenario/background/00/right': 'Right',
			'sidebar/scenario/background/00/visible': 'Visible',
			'sidebar/scenario/background/00/button/load': 'Load',
			'sidebar/scenario/background/00/button/generate': 'Generate Road',


			'menubar/file/save': 'Save',
			'menubar/file/open': 'Open',
			'menubar/file/import/dsl': 'Import DSL',
			'menubar/file/export/dsl': 'Export DSL',
			'menubar/file/export/waypoint': 'Export Waypoint',
			'menubar/file/export/analyser': 'Export Analyser',

			// Menu
			'menubar/add/road': 'Road',
			'menubar/add/junction': 'Junction',
			'menubar/add/roadmark/line': 'Line',
			'menubar/add/roadmark/arrow': 'Arrow',
			'menubar/add/roadmark/stopline': 'Stop Line',
			'menubar/add/roadmark/crosswalk': 'Crosswalk',
			'menubar/add/roadmark/trafficlight': 'Traffic Light',
			'menubar/add/roadmark/diamondmark': 'Diamond Mark',
			'menubar/add/roadmark/charactermark': 'Character Mark',
			'menubar/add/roadmark/turningmark':'Turn L/R',
			'menubar/add/actor': 'Actor',
			'menubar/add/trajectory': 'Trajectory',
			'menubar/add/route': 'Route',
			'menubar/examples/kouhokuinter': '港北インター',
			'menubar/examples/junction': '交差点',
			'menubar/examples/trajectory': 'ウェイポイント',
			'menubar/examples/newsample': 'サンプル',

			'menubar/examples/lane/01': '車線',
			'menubar/examples/road/curve': '道路（カーブ）',
			'menubar/examples/road/branch': '道路（分岐）',
			'menubar/examples/road/merge': '道路（合流）',

			'menubar/preview': 'Preview',
			'menubar/preview/play': 'Preview',
			'menubar/preview/stop': 'Stop',

			// Metal Data
			'sidebar/properties/scenario': 'Properties',
			'sidebar/scenario/id': 'ID',
			'sidebar/scenario/name': 'Name',
			'sidebar/scenario/description': 'Description',
			'sidebar/scenario/road/priority': 'Priority',
			'sidebar/scenario/road/connection': 'Connection',
			'sidebar/scenario/road/reverse': 'Reverse',
			'sidebar/scenario/road/length': 'Length',
			'sidebar/scenario/road/height': 'Height',
			'sidebar/scenario/road/rampangle': 'Ramp Angle',
			'sidebar/scenario/road/radius': 'Radius',
			'sidebar/scenario/road/actions/add': 'Add Lane (Ctrl+A)',
			'sidebar/scenario/road/type': 'Geometry Type',
			'sidebar/scenario/lane/position': 'Lane Position',
			'sidebar/scenario/lane/width': 'Lane Width',
			'sidebar/scenario/lane/type': 'Lane Type',
			'sidebar/scenario/refline/visible': 'Ref-Line',

			'sidebar/scenario/line/type': 'Line Type',
			'sidebar/scenario/line/position': 'Line Position',
			'sidebar/scenario/line/width': 'Line Width',
			'sidebar/scenario/line/offset': 'Line Offset',
			'sidebar/scenario/line/color': 'Line Color',
			'sidebar/scenario/line/actions/add': 'Add Lane',
			'sidebar/scenario/linesegment/lane': 'Lane',
			'sidebar/scenario/linesegment/start': 'Start',
			'sidebar/scenario/linesegment/end': 'End',

			'sidebar/scenario/sign/road': 'Road',
			'sidebar/scenario/sign/lane': 'Lane',
			'sidebar/scenario/sign/type': 'Type',
			'sidebar/scenario/sign/position': 'Position',
			'sidebar/scenario/sign/rotation': 'Rotation',
			'sidebar/scenario/sign/scale': 'Scale',
			'sidebar/scenario/sign/length': 'Length',
			'sidebar/scenario/sign/color': 'Color',

			'sidebar/scenario/trafficlight/road': 'Road',
			'sidebar/scenario/trafficlight/position': 'Position',
			'sidebar/scenario/trafficlight/orientation': 'Orientation',
			'sidebar/scenario/trafficlight/rotation': 'Rotation',

			'sidebar/scenario/crosswalk/road': 'Road',
			'sidebar/scenario/crosswalk/position': 'Position',
			'sidebar/scenario/crosswalk/width': 'Width',
			'sidebar/scenario/crosswalk/skew': 'Skew',
			'sidebar/scenario/crosswalk/color': 'Color',

			'sidebar/scenario/turningmark/type':'Type',
			'sidebar/scenario/turningmark/junction':'Junction',
			'sidebar/scenario/turningmark/scale':'Sacle',
			'sidebar/scenario/turningmark/rotation':'Rotation',
			'sidebar/scenario/turningmark/color':'Color',

			'sidebar/scenario/junction/edge/type': 'Edge Type',
			'sidebar/scenario/junction/connections': 'Connections',
			'sidebar/scenario/junction/connections/id': 'Connection ID',
			'sidebar/scenario/junction/connections/type': 'Connection Type',
			'sidebar/scenario/junction/connections/table/id': 'ID',
			'sidebar/scenario/junction/connections/table/type': 'TYPE',

			'sidebar/scenario/junction/connections/button/add': 'Add',
			'sidebar/scenario/junction/connections/button/edit': 'Edit',
			'sidebar/scenario/junction/connections/button/compute': 'Compute Lane',



			// Actor Data
			'sidebar/properties/roadmark': 'Properties',
			'sidebar/properties/actor': 'Properties',
			'sidebar/properties/trajectory': 'Properties',
			'sidebar/properties/route': 'Properties',
			'sidebar/actor/id': 'ID',
			'sidebar/scenario/actor/route': 'Route',
			'sidebar/scenario/actor/waypoints': 'WayPoints',

			// Actor Data
			'sidebar/scenario/route/route': 'Route',
			'sidebar/scenario/route/waypoints': 'WayPoints',
			'sidebar/scenario/route/pointprops': 'Properties',

			'sidebar/scenario/trajectory/button/compute': 'Compute',
			'sidebar/scenario/trajectory/line/base/color': 'Base',
			'sidebar/scenario/trajectory/line/mode/color': 'Mode',
			'sidebar/scenario/trajectory/line/average/color': 'Average',
			'sidebar/scenario/trajectory/line/edge/color': 'Edge',
			//#####################################
			...
			'menubar/edit/clone_connect': 'Clone & Connect (Ctrl+Shift+C)',
