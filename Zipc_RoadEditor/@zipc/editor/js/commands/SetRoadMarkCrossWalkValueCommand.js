...
var SetRoadMarkCrossWalkValueCommand = function (editor, object, attributeName, newValue) {

	Command.call(this, editor);

	this.type = 'SetRoadMarkCrossWalkValueCommand';
...
SetRoadMarkCrossWalkValueCommand.prototype = {

	execute: function () {
		if (this.object.type !== 'RoadMark.Crosswalk') {
			return;
		}
...
export { SetRoadMarkCrossWalkValueCommand };
