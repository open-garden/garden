...
var SetRoadMarkTurningMarkValueCommand = function (editor, object, attributeName, newValue) {

    Command.call(this, editor);

    this.type = 'SetRoadMarkTurningMarkValueCommand';
...
SetRoadMarkTurningMarkValueCommand.prototype = {

    execute: function () {
        if (this.object.type !== 'RoadMark.TurningMark') {
            return;
        }

        if (this.attributeName === 'road') {
            this.editor.moveObject(this.object, this.newValue, this.object.parent);
        } else if (this.attributeName === 'junction') {
            this.editor.moveObject(this.object, this.newValue, this.object.parent);
...
export { SetRoadMarkTurningMarkValueCommand };
