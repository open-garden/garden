(function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
	"/Users/joshua/dev/gits/timeliner/node_modules/do.js/do.js": [function (require, module, exports) {
		function Do(parent) {
			var listeners = [];
		...
		function LayerCabinet(data, context) {
			...
			*/
			...
			function repaint(s) {
				...
				s = currentTimeStore.value || 0.000001;
		...
		*/
			...
			function drawLayerContents() {
				...
				for (i = 0; i < il; i++) {
					...
					for (var j = 0; j < values.length - 1; j++) {
						...
						if (frame.tween === "along") {
							y2 -= 11;
						} else if (frame.tween === "right_change") {
							y2 -= 22;
						}
		...
		function Timeliner(target, controller) {
			...
			controller.setDuration(data.get('ui:totalTime').value);
			...
			var layer_panel = new LayerCabinet(data, context);
			...
			function setCurrentTime(value) {
				...
				controller.setDisplayTime(value);
			...
			*/
			...
			title_bar.innerHTML = 'Timeline View';
			...
			*/
			...
			(function DockingWindow() {
					...
					if (clicked && clicked.isMoving) {
						...
						switch (checks()) {
							case 'full-screen':
								...
								break;
							case 'snap-top-edge':
								setBounds(ghostpane, 0, 0, window.innerWidth, Settings.height);
								// setBounds(ghostpane, 0, 0, window.innerWidth, window.innerHeight / 2);
								ghostpane.style.opacity = 0.2;
								break;
							case 'snap-left-edge':
								setBounds(ghostpane, 0, 0, window.innerWidth / 3, window.innerHeight);
								ghostpane.style.opacity = 0.2;
								break;
							case 'snap-right-edge':
								setBounds(ghostpane, window.innerWidth * 2 / 3, 0, window.innerWidth / 3, window.innerHeight);
								ghostpane.style.opacity = 0.2;
								break;
				...
				function resizeEdges() {
					switch (snapType) {
						...
						case 'snap-top-edge':
							// hintTop();
							setBounds(pane, 0, 0, window.innerWidth, Settings.height);
							// setBounds(pane, 0, 0, window.innerWidth, window.innerHeight / 2);
							break;
						case 'snap-left-edge':
							// hintLeft();
							setBounds(pane, 0, 0, window.innerWidth / 3, window.innerHeight);
							break;
						case 'snap-right-edge':
							setBounds(pane, window.innerWidth * 2 / 3, 0, window.innerWidth / 3, window.innerHeight);
							break;
						case 'snap-bottom-edge':
							setBounds(pane, 0, window.innerHeight - Settings.height, window.innerWidth, Settings.height);
			...
			this.setDisplay = function (value) {
				...
				pane.style.display = value !== undefined ? value : 'none';

				ghostpane.style.display = value !== undefined ? value : 'none';
			...
			this.startPlay = function (value) {

				layer_panel.startPlay();
		...
		var Tweens = {
			...
			left_change: function (k) {
				if ((k *= 2) < 1) return 0.5 * k * k;
				return - 0.5 * (--k * (k - 2) - 1);
			},
			right_change: function (k) {
				if ((k *= 2) < 1) return -(0.5 * k * k);
				return 0.5 * (--k * (k - 2) - 1);
			},
			way_point: function (k) {
				return 0;
			}
		};
		...
		function LayerView(layer, dispatcher) {
			...
			var dropdown = document.createElement('select');
			var option;
			dropdown.style.cssText = 'font-size: 12px; width: 100px; margin: 0; float: right; text-align: right;';
		...
		*/
		...
		function ScrollBar(h, w, dispatcher) {
			...
			scrolltrack.style.width = SCROLL_WIDTH + 'px'; //SCROLLBAR_WIDTH;
