...
/**
 * Used in vertical auto layout.<br>
 * Get the coordinates for aligning nodes from top to bottom
 */
public class TopToBottomStrategy extends TreeLayoutStrategy {
     ...
     */
    public TopToBottomStrategy(int originTop, int originLeft, int gutterWidth, int gutterHeight) {
